...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mega Aulão ao Vivo sobre Leilões" },
      {
        name: "description",
        content:
          "Aulão ao vivo com Paulo Machado para você fazer sua primeira arrematação em leilões.",
      },
      { name: "author", content: "Paulo Machado" },
...
const META_PIXEL_ID = "1076946837698511";
